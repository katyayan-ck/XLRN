                    ...
                    <form method="POST" action="{{ backpack_url('vertical/' . $vertical->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="form-label fw-bold">Vertical ID</label>
                                        <div class="readonly-value">{{ $vertical->id }}</div>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label fw-bold">Created At</label>
                                        <div class="readonly-value">
                                            {{ $vertical->created_at?->format('d-m-Y H:i') ?? '—' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label>Vertical Code <span class="text-danger">*</span></label>
                                <input type="text" name="code" class="form-control"
                                    value="{{ old('code', $vertical->code) }}" maxlength="5" required>
                            </div>
