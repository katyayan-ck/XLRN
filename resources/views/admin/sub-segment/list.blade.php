...
@section('title', 'All Sub Segments')
...
<script>
    ...
    const columnDefs = [
        ...getCols(['serial_no', 'code', 'name', 'brand', 'segment']).map(col => {
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'code', 'name', 'brand', 'segment', 'description', 'is_active', 'action'];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'code', 'name', 'brand', 'segment']),
            ...getCols(['description']),
            ...getCols(['is_active']),
            ...getCols(['action'])
        ];
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'code', 'name', 'brand', 'segment'].includes(col.field)) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "SubSegments");
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`subsegments-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('sub-segment/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Sub Segment
                    </a>
                </div>
            </div>
