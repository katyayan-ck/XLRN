        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('graph-edge/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Edge
                    </a>
                </div>
            </div>
...
<script>
    ...
    const columnGroups = [
        {
            ...
            children: getCols(['serial_no', 'from_node', 'to_node']).map(col => {
                if (col.field === 'serial_no') col.pinned = 'left';
                return col;
            })
        },
        {
            headerName: 'Edge Details',
            headerClass: 'center-header',
            children: getCols(['type', 'level'])
        },
        {
            headerName: 'Powers',
            headerClass: 'center-header',
            children: getCols(['powers'])
        },
        {
            headerName: 'Info',
            headerClass: 'center-header',
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "GraphEdges");
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`graph-edges-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush