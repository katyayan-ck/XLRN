...
@section('title', 'All Vehicle Models')
...
<script>
    ...
    const columnDefs = [
        {
            ...
            children: getCols(['serial_no', 'brand', 'segment', 'sub_segment']).map(col => {
    ...
    function openColumnBubble() {
        ...
        columnDefs.forEach(group => {
            ...
            if (groupName === 'Hierarchy' || groupName === 'Model Information') {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "VehicleModels");
            XLSX.writeFile(wb, `vehicle-models-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`vehicle-models-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('vehicle-model/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Vehicle Model
                    </a>
                </div>
            </div>
