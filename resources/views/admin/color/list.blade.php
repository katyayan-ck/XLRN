...
<script>
    ...
    const columnDefs = [
        ...getCols(['serial_no', 'brand', 'name', 'code']).map(col => {
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'brand', 'name', 'code', 'hex_code', 'is_active', 'action'];
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'brand', 'name', 'code']),
            ...getCols(['hex_code']),
            ...getCols(['is_active']),
            ...getCols(['action'])
        ];
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'brand', 'name', 'code'].includes(col.field)) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`colors-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('color/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Color
                    </a>
                </div>
            </div>
