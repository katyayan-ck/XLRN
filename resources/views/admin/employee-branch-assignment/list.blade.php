        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('employee-branch-assignment/create') }}"
...
<script>
    ...
    // Define default fields once
    const DEFAULT_FIELDS = ['serial_no', 'employee_code', 'employee_name', 'branch_name', 'from_date', 'to_date', 'is_primary', 'action'];
    ...
    const columnDefs = [
        ...
        {
            headerName: 'Branch & Period',
            headerClass: 'center-header',
            children: getCols(['branch_name', 'from_date', 'to_date'])
        },
        {
            headerName: 'Status',
            headerClass: 'center-header',
            children: getCols(['is_primary', 'is_current'])
        },
        {
            headerName: 'Actions',
            headerClass: 'center-header',
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            // IMPORTANT: Show only Default Headers on page load
            const allCols = [];
    ...
    function openColumnBubble() {
        // ... (keeping your existing function - no change needed)
        ...
        columnDefs.forEach(group => {
            ...
            // ... rest of your popup logic remains same
            ...
            children.forEach(col => {
                ...
                checkbox.addEventListener('change', () => gridApi.setColumnsVisible([col.field], checkbox.checked));
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.writeFile(wb, `employee-branch-assignments-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`employee-branch-assignments-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush