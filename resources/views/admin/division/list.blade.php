        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('division/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Division
                    </a>
                </div>
            </div>
...
<script>
    ...
    const columnDefs = [
        ...ALL_COLUMNS.filter(col => ['serial_no', 'code', 'name', 'department'].includes(col.field)),
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'code', 'name', 'department', 'description', 'action'];
    ...
    function openColumnBubble() {
        ...
        allFlatColumns.forEach(col => {
            ...
            // Primary fields ko disable rakho
            if (['serial_no', 'code', 'name', 'department'].includes(col.field)) {
                checkbox.disabled = true;
            }

            // Action column ko disable rakho
            if (col.field === 'action') {
                checkbox.disabled = true;
            }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.writeFile(wb, `divisions-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`divisions-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush