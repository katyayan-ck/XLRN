        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('employee/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
    ...
    const columnDefs = [
        {
            ...
            children: ALL_COLUMNS.filter(col => ['serial_no', 'code', 'person_name'].includes(col.field))
        },
        {
            headerName: 'Job Details',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['designation_name', 'branch_name', 'department_name'].includes(col.field))
        },
        {
            headerName: 'Dates',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['joining_date'].includes(col.field))
        },
        {
            headerName: 'Status',
            headerClass: 'center-header',
