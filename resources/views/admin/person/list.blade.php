...
<script>
    ...
    const columnDefs = [
        {
            ...
            children: ALL_COLUMNS.filter(col => ['serial_no', 'code', 'full_name', 'display_name'].includes(col.field))
        },
        {
            headerName: 'Personal',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['salutation', 'gender', 'dob'].includes(col.field))
        },
        {
            headerName: 'Contact',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['mobile_primary', 'email_primary'].includes(col.field))
        },
        {
            headerName: 'Actions',
            headerClass: 'center-header',
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            gridApi = params.api;
            const defaultFields = ['serial_no', 'code', 'full_name', 'display_name', 'gender', 'mobile_primary', 'email_primary', 'action'];
            const allCols = [];
