...
<script>
    ...
    const DEFAULT_FIELDS = ['serial_no', 'employee_code', 'employee_name', 'location_name', 'branch_name', 'from_date', 'action'];
    ...
    const columnDefs = [
        ...
        {
            headerName: 'Location & Branch',
            headerClass: 'center-header',
            children: getCols(['location_name', 'branch_name'])
        },
        {
            headerName: 'Period',
            headerClass: 'center-header',
