...
@section('title', 'Employee Location Assignments')
...
<script>
    ...
    const columnDefs = [
        ...
        ...getCols(['location_name', 'branch_name']),
    ...
    const gridOptions = {
        ...
        onGridReady: params => {
            ...
            const defaultFields = ['serial_no', 'employee_code', 'employee_name', 'location_name', 'branch_name', 'from_date', 'action'];
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "LocationAssignments");
            XLSX.writeFile(wb, `employee-location-assignments-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`employee-location-assignments-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush
        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('employee-location-assignment/create') }}"
