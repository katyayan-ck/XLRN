        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('process/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Process
                    </a>
                </div>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.autoTable({ head: [headers], body: rows, styles: { fontSize: 8 }, headStyles: { fillColor: [41, 128, 185] } });
            doc.save(`processes-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush