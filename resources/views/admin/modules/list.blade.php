        ...
        <div class="card">
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('modules/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
<script>
    ...
    // Default Visible Fields on Page Load
    ...
    // Grouped Column Definition (Best Approach)
    const columnGroups = [
        {
            headerName: 'Primary',
            headerClass: 'center-header',
            children: getCols(['serial_no', 'code', 'name']).map(col => {
    ...
    // Customise Headers Popup (Best grouped logic with indeterminate support)
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('btnDefaultHeaders').addEventListener('click', () => {
            ...
            setTimeout(() => {
                gridApi.autoSizeColumns(gridApi.getAllDisplayedColumns().map(c => c.getColId()), false);
            }, 200);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`modules-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush