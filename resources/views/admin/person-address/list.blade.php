        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('person-address/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
...
<script>
    ...
    const columnDefs = [
        {
            ...
            children: ALL_COLUMNS.filter(col => ['serial_no', 'person_name', 'type'].includes(col.field))
        },
        {
            headerName: 'Address',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['address_line_1', 'city', 'state', 'pincode'].includes(col.field))
        },
        {
            headerName: 'Status',
            headerClass: 'center-header',
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "PersonAddresses");
            XLSX.writeFile(wb, `person-addresses-${new Date().toISOString().slice(0,10)}.xlsx`);
        });
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`person-addresses-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush