                    ...
                    <form method="POST" action="{{ backpack_url('variant') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="sub_segment_id" class="form-control form-select">
                                    ...
                                    <option value="{{ $sub->id }}" {{ old('sub_segment_id')==$sub->id ? 'selected' : ''
                                        }}>
                                        {{ $sub->name }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="oem_code" class="form-control text-uppercase"
                                    value="{{ old('oem_code') }}" style="text-transform: uppercase;">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <label>Wheels</label>
                                <input type="number" name="wheels" class="form-control" value="{{ old('wheels', 4) }}"
                                    min="2">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label>GVW (kg)</label>
                                <input type="number" name="gvw" class="form-control" value="{{ old('gvw') }}">
                            </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-success btn-lg px-5">
                                <i class="la la-save"></i> Create Variant
                            </button>
