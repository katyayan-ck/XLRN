        ...
        <div class="card">
            <div
                ...
                <div class="d-flex align-items-center gap-3 flex-nowrap">
                    <a href="{{ backpack_url('person-contact/create') }}" class="btn btn-blue btn-sm fw-bold shadow-sm">
                        <i class="la la-plus me-1"></i> Add New Contact
                    </a>
                </div>
            </div>
...
<script>
    ...
    const columnDefs = [
        {
            ...
            children: ALL_COLUMNS.filter(col => ['serial_no', 'person_name', 'name'].includes(col.field))
        },
        {
            headerName: 'Contact',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['type', 'mobile', 'email'].includes(col.field))
        },
        {
            headerName: 'Details',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['relationship'].includes(col.field))
        },
        {
            headerName: 'Status',
            headerClass: 'center-header',
            children: ALL_COLUMNS.filter(col => ['is_primary'].includes(col.field))
        },
        {
            headerName: 'Actions',
            headerClass: 'center-header',
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('exportCsv').addEventListener('click', () => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "PersonContacts");
        ...
        document.getElementById('exportPdf').addEventListener('click', () => {
            ...
            doc.save(`person-contacts-${new Date().toISOString().slice(0,10)}.pdf`);
        });
    });
</script>
@endpush