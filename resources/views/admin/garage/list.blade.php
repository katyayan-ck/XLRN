...
<script>
    ...
    const columnDefs = [
        ...getCols(['serial_no', 'name', 'person_name']).map(col => {
    ...
    function openColumnBubble() {
        ...
        const allFlatColumns = [
            ...getCols(['serial_no', 'name', 'person_name']),
            ...getCols(['address', 'city', 'state']),
            ...getCols(['mobile']),
            ...getCols(['is_active']),
            ...getCols(['action'])
        ...
        allFlatColumns.forEach(col => {
            ...
            if (['serial_no', 'name', 'person_name'].includes(col.field)) {
