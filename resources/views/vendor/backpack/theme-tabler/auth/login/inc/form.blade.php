...
<div class="text-center my-4">
    <img src="{{ asset('images/xceler8.png') }}" alt="Xceler8 Logo" style="height:75px;">
</div>
...
<form method="POST" action="{{ route('backpack.auth.login') }}" autocomplete="off" novalidate="">
    ...
    <div class="mb-3">
        <label class="form-label" for="{{ $username }}">{{
            trans('backpack::base.'.strtolower(config('backpack.base.authentication_column_name'))) }}</label>
    ...
    <div class="mb-2">
        ...
        <div class="input-group input-group-flat password-visibility-toggler">
            ...
            <span class="input-group-text p-0 px-2">
                ...
                <a href="#" data-input-type="password" class="link-secondary p-2 d-none" data-bs-toggle="tooltip"
